...
| `activities/food-idioms/` | The food idioms session in three pieces for Moodle: `discussion.html`, `meanings.html`, `matching.html`, and `whiteboard-race.html`, the picture presenter for Sarah's marker race (pictures embedded, 1.2 MB). SAB2 S3 session 3. |
